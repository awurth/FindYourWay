...
export default function GameController ($scope, $state, $stateParams, $window, NgMap, GeoService, Game) {
  ...
  // Game.get({ id: $stateParams.id }, (game) => {
    // $scope.game = game
  $scope.game = {
...
GameController.$inject = ['$scope', '$state', '$stateParams', '$window', 'NgMap', 'GeoService', 'Game']
